    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[60vh] bg-forest">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 px-4 md:px-6">
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-white mb-4 text-center">Behind the Scenes with Káàbò</h1>
          ...
          <div className="mt-4 md:mt-6 text-center">
            <p className="text-lg md:text-xl lg:text-2xl font-light">November 2025</p>
          </div>
        </div>
      </section>
