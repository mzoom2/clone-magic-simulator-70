    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[60vh] bg-forest">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 px-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-white mb-4 text-center">Lagos Fashion Week</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-xl md:text-2xl font-light">OCTOBER 2025</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-black text-white text-center">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <h2 className="text-2xl md:text-3xl mb-6">Choose the package that best fits your needs and schedule.</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="overflow-hidden rounded-none border-none">
              <div className="bg-[#FEF7CD] py-6 text-center">
                <h3 className="text-2xl md:text-3xl font-medium text-forest">FASHION WEEK</h3>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium">Double Occupancy:</h3>
                <p>Choose to save by sharing costs with a friend</p>
              </div>
            </div>
          </div>
        </div>
