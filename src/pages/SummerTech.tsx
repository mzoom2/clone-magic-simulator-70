    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[60vh] bg-forest">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 px-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-white mb-4 text-center">Summer Tech</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-xl md:text-2xl font-light">JUNE 19TH - 21ST, 2025</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="overflow-hidden rounded-none border-none">
              <div className="bg-[#FEF7CD] py-6 text-center">
                <h3 className="text-2xl md:text-3xl font-medium text-forest">SUMMER TECH</h3>
              ...
              <CardContent className="p-0">
                <div className="pt-8 pb-4 text-center">
                  <div className="inline-flex items-baseline">
                    ...
                    <span className="text-forest text-6xl font-medium">1,900</span>
